...
class TriangleDrawer(Drawer):
    ...
    def draw(cls, surface, triangle: Triangle, color):
        ...
        if triangle.v2[1] == triangle.v3[1]:
            ...
            aux = triangle.v1[0] + (triangle.v2[1] - triangle.v1[1]) / (triangle.v3[1] - triangle.v1[1]) * (triangle.v3[0] - triangle.v1[0])
            v4 = np.array([int(aux), triangle.v2[1]])
...
if __name__ == '__main__':
    t = Triangle(np.array([4, 5]), np.array([2, 3]), np.array([1, 2]))
